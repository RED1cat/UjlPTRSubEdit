            ...
            if (openFileDialog1.ShowDialog() == DialogResult.OK)
            {
                try
                {
                    ...
                    using (Stream str = openFileDialog1.OpenFile())
                    {
                        ...
                        if (OpenFile.FileName == "COMOD11.SNG" || OpenFile.FileName == "COMOD0.MEN" || OpenFile.FileName == "COMOD6.SNG" || OpenFile.FileName == "COMOD16.SNG" || OpenFile.FileName == "COMOD16.CMP" || OpenFile.FileName == "COMOD6.CMP" || OpenFile.FileName == "COMOD6.COP")
                        {
